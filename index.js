// Get your shorts on - this is an array workout!
    ...
    const inventors = [
      ...
      const bornInFifties = inventors.filter(inventor =>{
          return (inventor.year > 1500 && inventor.year < 1600) || (inventor.passed > 1500 && inventor.passed < 1600);
      });
  
      // Array.prototype.map()
      // 2. Give us an array of the inventors first and last names
      const inventorNamesSurnames = inventors.map(inventor => {
          return {name: inventor.first, surname: inventor.last};
      });
      ...
      const summedUpData = data.reduce((prev, cur) => {
